...
class RolesAndPermissionsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $reasons = [
            ...
            ['name' => 'Goods Received', 'slug' => 'goods-received',  'description' => 'Goods received from supplier, transfer, etc.'],
            ['name' => 'Stock Correction (In)', 'slug' => 'stock-correction-in',  'description' => 'Positive adjustment to correct stock discrepancies.'],
            ['name' => 'Stock Correction (Out)', 'slug' => 'stock-correction-out',  'description' => 'Negative adjustment to correct stock discrepancies.'],
            ['name' => 'Transfer In', 'slug' => 'transfer-in',  'description' => 'Transfer of stock IN from another store.'],
            ['name' => 'Transfer Out', 'slug' => 'transfer-out',  'description' => 'Transfer of stock OUT to another store.'],
            ['name' => 'New Stock', 'slug' => 'new-stock',  'description' => 'New stock added to inventory.'],
            ['name' => 'Damaged Goods', 'slug' => 'damaged-goods',  'description' => 'Stock removed due to damage.'],
            ['name' => 'Theft', 'slug' => 'theft',  'description' => 'Stock removed due to theft.'],
            ['name' => 'Expired Goods', 'slug' => 'expired-goods',  'description' => 'Stock removed due to expiration.'],
            ['name' => 'Customer Return', 'slug' => 'customer-return',  'description' => 'Stock returned by customers.'],
            ['name' => 'Supplier Return', 'slug' => 'supplier-return',  'description' => 'Stock returned to suppliers.'],
            ['name' => 'Posted Invoice', 'slug' => 'posted-invoice',  'description' => 'Stock reduction due to invoice sales'],
            ['name' => 'Refunded Invoice', 'slug' => 'refunded-invoice',  'description' => 'Stock return due to refunded invoice'],
            ['name' => 'POS Sale', 'slug' => 'pos-sale',  'description' => 'Stock reduction due to POS sales'],
            ['name' => 'POS Refund', 'slug' => 'pos-refund',  'description' => 'Stock return due to POS refund'],
        ];
