...
export const SupplierTableConfig = {
  columns: [
    { label: 'Supplier Name', key: 'name', className: 'p-4 border' },
    { label: 'Contact Person', key: 'contact_person', className: 'p-4 border' }, // 🟢 New Column
    { label: 'Email', key: 'email', className: 'p-4 border' },                     // 🟢 New Column
    { label: 'Phone', key: 'phone', className: 'p-4 border' },                     // 🟢 New Column
    // ❌ Removed Logo column
